...
export const ContactButtons = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  (props, ref) => {
    const handleCall = () => {
    ...
    return (
      <div ref={ref} className="flex flex-col sm:flex-row gap-3 w-full" {...props}>
        <Button 
          variant="outline" 
          size="lg" 
          className="flex-1"
